...
public class Table {
	...
	String registryname;
	String type;
	Table.Column[] tbColumn;

	public Table(String name, String description, String hidden, String registryname) {
		super();
		this.name = name;
	...
	public Table.Column[] geTbColumn() {
		return tbColumn;
	}

	public void setWbColumn(Table.Column[] wbColumn) {
		this.tbColumn = wbColumn;
	}
